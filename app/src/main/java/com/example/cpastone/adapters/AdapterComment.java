...
import com.example.cpastone.databinding.RowCommentBinding;
...
// getting data from specific position of the list
        ...
        // handles click, show options to delete comment
        ...
        builder.setTitle(" Delete Comment")
                ...
                .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        // delete from dialog clicked, begin to delete
                        ...
                        ref.child(modelComment.getBookId())
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(context, "Failed tp delete due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                })
