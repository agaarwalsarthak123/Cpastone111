...
public class PdfAddActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ADD_PDF_TAG";   // debugging
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // handles click to go to previous activity
    ...
    private void validateData() {
        ...
        if(TextUtils.isEmpty(title)) {
            ...
            // all the data is valid, it would be uploaded now
            uploadPdfToStorage();
        }
    ...
    private void uploadPdfToStorage() {
        ...
        Log.d(TAG, "uploadPdfToStorage: Uploading it to free storage");
        ...
        storageReference.putFile(pdfUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Log.d(TAG, "onSuucess: getting pdf url");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Log.d(TAG, "Failure: PAD upload failed due to " +e.getMessage());
    ...
    private void uploadPdfInfoToDb(String uploadedPdfUrl, long timestamp) {
        // Step 3: Upload Pdf info firebase db
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        progressDialog.dismiss();
                        Log.d(TAG, "OnSuccess: Successfully uploaded your pdf...");
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    // getting id and title of category
    ...
    private void categoryPickDialog() {
        // getting categories form firebase
