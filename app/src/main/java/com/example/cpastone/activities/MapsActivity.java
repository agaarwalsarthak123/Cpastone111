...
import com.example.cpastone.databinding.ActivityMapsBinding;
        ...
        mUsers.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot s : dataSnapshot.getChildren()) {
                    ModelDoner user = s.getValue(ModelDoner.class);
                    double x = Double.parseDouble(user.getLatitude());
                    double y = Double.parseDouble(user.getLongitude());
                    Log.d("xLatitude", ""+x);
                    Log.d("xLongitude", ""+y);
